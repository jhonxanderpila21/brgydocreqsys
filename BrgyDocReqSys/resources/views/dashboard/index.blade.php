...
@section('content')
    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3 mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Key statistics and recent activity for the barangay document system.</p>
        </div>
    </div>

    @if($userRole === \App\Models\User::ROLE_RESIDENT)
        <div class="row g-4 mb-4">
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <h5 class="card-title">Resident Portal</h5>
                        <p class="text-muted mb-3">Welcome to the resident portal. You can file requests and check your request status here.</p>
                        <div class="row g-3">
                            <div class="col-12 col-md-4">
                                <div class="card border-0 bg-light h-100">
                                    <div class="card-body text-center">
                                        <div class="h1 mb-2">{{ number_format($stats['total_requests']) }}</div>
                                        <p class="mb-0 text-muted">Total Document Requests</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="card border-0 bg-light h-100">
                                    <div class="card-body text-center">
                                        <div class="h1 mb-2">{{ number_format($stats['pending_requests']) }}</div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="card border-0 bg-light h-100">
                                    <div class="card-body text-center">
                                        <div class="h1 mb-2">{{ number_format($stats['processed_requests']) }}</div>
                                        <p class="mb-0 text-muted">Processed Requests</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mt-4">
                            <p class="mb-1">Resident access is restricted to request filing and status checks. Please contact the barangay office if you need additional support.</p>
                        </div>
                    </div>
                </div>
            </div>
